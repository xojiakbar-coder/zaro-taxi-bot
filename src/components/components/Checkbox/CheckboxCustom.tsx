...
const CheckboxCustom: React.FC<IPropsCustom> = ({ checked, className, disabled = false, label, onChange }) => {
  return (
    <div className={cx(classes.container, className && className)} onClick={() => onChange && onChange(!checked)}>
      <div
        className={cx(
          classes.wrapper,
