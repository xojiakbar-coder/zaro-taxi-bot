...
const SvgUsersTriple = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" ref={ref} {...props}>
    <ellipse cx={12} cy={16.5} stroke="currentColor" strokeLinejoin="round" strokeWidth={1.5} rx={6} ry={2.5} />
    <circle cx={12} cy={8} r={3} stroke="currentColor" strokeLinejoin="round" strokeWidth={1.5} />
    <path
      fill="currentColor"
      fillRule="evenodd"
